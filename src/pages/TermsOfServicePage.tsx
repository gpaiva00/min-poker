      ...
      <div className='mx-auto max-w-4xl'>
        ...
        <div className='space-y-8 rounded-lg bg-white p-8 shadow-sm'>
          ...
          <section>
            ...
            <div className='space-y-4 text-gray-700'>
              <p>
                O minPoker é uma ferramenta gratuita de Planning Poker online
                que permite equipes realizarem estimativas colaborativas em
                tempo real para metodologias ágeis de desenvolvimento.
              </p>
          ...
          <section>
            ...
            <div className='space-y-4 text-gray-700'>
              <p>
                ...
                participar das sessões fornecendo apenas um nome de
                identificação.
              </p>
              <p>
                Você é responsável por manter a confidencialidade dos códigos de
                sala que criar e por todas as atividades que ocorrem em suas
                salas.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='space-y-4 text-gray-700'>
              <p>
                O minPoker e todo seu conteúdo, recursos e funcionalidades são
                de propriedade exclusiva da equipe de desenvolvimento e são
          ...
          <section>
            ...
            <div className='space-y-4 text-gray-700'>
              <p>
                O minPoker é fornecido "como está" sem garantias de qualquer
                tipo. Não garantimos que o serviço será ininterrupto, livre de
                erros ou completamente seguro.
              </p>
              <p>
          ...
          <section>
            ...
            <div className='space-y-4 text-gray-700'>
              <p>
                Podemos atualizar estes Termos de Uso periodicamente. As
